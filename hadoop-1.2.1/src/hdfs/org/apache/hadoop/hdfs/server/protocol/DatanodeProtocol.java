...
public interface DatanodeProtocol extends VersionedProtocol {
  ...
  public void blockReceived(DatanodeRegistration registration,
    ...
    /**
   * blockUpdated() allows the DataNode to tell the NameNode about
   * recently-updated block data, with a hint for pereferred replica
   * to be deleted when there is any excessive blocks.
   */
  public void blockUpdated(DatanodeRegistration registration,
                            Block blocks[],
                            String[] delHints) throws IOException;

  /**
   * Create new block when local file grows over DEFAULT_BLOCK_SIZE
   */

  public Block newBlockForLocalFile(DatanodeRegistration registration,
                                    Block block)
                                    throws IOException;
