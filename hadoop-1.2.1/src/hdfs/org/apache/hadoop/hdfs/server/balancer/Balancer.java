...
public class Balancer implements Tool {
  ...
  private long initNodes(DatanodeInfo[] datanodes) {
    ...
    System.out.println("Average util is " + avgUtilization);
    ...
    for (DatanodeInfo datanode : datanodes) {
      ...
      System.out.println("This node has util " + getUtilization(datanode));
      if (getUtilization(datanode) > avgUtilization) {
        System.out.println("Node " + datanode.getName() + " has above avg util");
  ...
  private boolean isOverUtilized(BalancerDatanode datanode) {
    System.out.println("Node " + datanode.getName() + " util " + 
