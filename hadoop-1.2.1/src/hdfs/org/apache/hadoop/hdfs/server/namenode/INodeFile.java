...
class INodeFile extends INode {
  ...
  void addBlock(BlockInfo newblock) {
    NameNode.LOG.info("In INodeFile addBlock, " + newblock.getBlockName() 
  ...
  long[] computeContentSummary(long[] summary) {
    long bytes = 0;
    NameNode.LOG.info("In INodeFile, computeContentSummary");
    for(Block blk : blocks) {
      NameNode.LOG.info("Adding " + blk.getNumBytes() + " bytes from " + blk.getBlockName());
