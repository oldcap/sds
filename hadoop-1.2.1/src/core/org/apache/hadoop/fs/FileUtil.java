...
public class FileUtil {
  ...
  /** Copy files between FileSystems. */
  public static boolean compose(ArrayList<String> composeConfig, 
                             FileSystem dstFS, Path dst,
                             boolean overwrite) throws IOException {
    dst = checkDest(dst.getName(), dstFS, dst, overwrite);
    OutputStream out = null;
    try {
      out = dstFS.create(dst, composeConfig, overwrite);
    } catch (IOException e) {
  ...
  public static boolean copy(FileSystem srcFS, Path src, 
    ...
    if (srcFS.getFileStatus(src).isDir()) {
      System.out.println("src " + src.toString() + " is dir");
      ...
      System.out.println("src " + src.toString() + " is file");
      InputStream in=null;
      OutputStream out = null;
      try {
        in = srcFS.open(src);
  ...
  public static boolean copy(File src,
    ...
    if (src.isDirectory()) {
      ...
      try {
        ...
        System.out.println("doing copyBytes");
